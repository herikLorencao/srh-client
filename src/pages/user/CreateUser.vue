    ...
    <q-card v-if="!loading" flat bordered class="signup-card flex column items-center">
      ...
      <q-card-section class="create-user-form">
        <q-form @submit="submitCreateUser" class="flex column items-center">
          <q-input class="user-create-input" color="orange" v-model="userForm.name"
                   placeholder="Nome" required/>
          <q-input class="user-create-input" color="orange" v-model="userForm.login"
                   placeholder="Login" required/>
          <q-input class="user-create-input" color="orange" v-model="userForm.email"
                   placeholder="Email" type="email" required/>
          <q-input class="user-create-input" color="orange" v-model="userForm.password"
                   placeholder="Senha" type="password" required/>
          <q-input class="user-create-input" color="orange" v-model="verifyPassword"
